  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-slate-100 flex flex-col justify-between relative overflow-hidden font-sans p-6 md:p-10 select-none">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center my-auto z-10">
        ...
        <div className="glass-panel p-8 md:p-10 w-full max-w-lg mx-auto bg-slate-900/40 border-slate-800/80 shadow-2xl relative">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-white tracking-tight">Welcome Back!</h3>
              <p className="text-[11px] text-slate-500 mt-0.5">Login to your account and continue building amazing projects.</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-6">
            ...
            <div className="flex items-center justify-between text-[11px] pt-1">
              <label className="flex items-center gap-2 cursor-pointer text-slate-400 font-medium select-none">
                <input type="checkbox" className="rounded bg-slate-950 border-slate-800 text-indigo-500 focus:ring-indigo-500/50 h-3.5 w-3.5" />
                <span>Remember me</span>
              </label>
              <span className="text-indigo-400 hover:underline cursor-pointer font-semibold">Forgot Password?</span>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full py-3 flex items-center justify-center gap-2 text-xs font-bold mt-4"
            >
